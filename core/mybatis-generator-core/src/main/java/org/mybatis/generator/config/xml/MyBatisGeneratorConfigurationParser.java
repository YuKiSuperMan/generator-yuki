...
public class MyBatisGeneratorConfigurationParser {
    ...
    protected void parseJavaBizGenerator(Context context, Node node) {
        JavaBizGeneratorConfiguration javaBizGeneratorConfiguration = new JavaBizGeneratorConfiguration();

        context.setJavaBizGeneratorConfiguration(javaBizGeneratorConfiguration);
        Properties attributes = parseAttributes(node);
        String type = attributes.getProperty("type"); //$NON-NLS-1$
        String targetPackage = attributes.getProperty("targetPackage"); //$NON-NLS-1$
        String targetProject = attributes.getProperty("targetProject"); //$NON-NLS-1$
        ...
        javaBizGeneratorConfiguration.setConfigurationType(type);
        javaBizGeneratorConfiguration.setTargetPackage(targetPackage);
        javaBizGeneratorConfiguration.setTargetProject(targetProject);
        javaBizGeneratorConfiguration
                .setImplementationPackage(implementationPackage);
