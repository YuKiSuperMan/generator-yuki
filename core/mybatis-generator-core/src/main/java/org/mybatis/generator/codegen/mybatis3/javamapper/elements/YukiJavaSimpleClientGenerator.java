 ...
 */
public class YukiJavaSimpleClientGenerator extends AbstractJavaClientGenerator {

    public YukiJavaSimpleClientGenerator(String project) {
        this(project, true);
    }

    public YukiJavaSimpleClientGenerator(String project, boolean requiresMatchedXMLGenerator) {
    ...
    protected void addNimbleSelectByExampleMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateNimbleSelectByExample()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new NimbleSelectByExampleMethodGenerator(false);
    ...
    public AbstractXmlGenerator getMatchedXMLGenerator() {
        return new LxyXMLMapperGenerator();
    }
}
