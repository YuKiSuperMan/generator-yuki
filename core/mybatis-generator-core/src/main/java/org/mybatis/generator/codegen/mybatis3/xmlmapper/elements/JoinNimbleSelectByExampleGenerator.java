 ...
 */
public class JoinNimbleSelectByExampleGenerator extends
        AbstractXmlElementGenerator {

    public JoinNimbleSelectByExampleGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getNimbleSelectByExampleId() + "ByJoin")); //$NON-NLS-1$
        ...
        answer.addElement(new TextElement("${columnList}"));
