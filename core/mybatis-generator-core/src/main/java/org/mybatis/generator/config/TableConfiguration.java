...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean nimbleSelectByExampleStatementEnabled;
    ...
    public void setBaseNimbleColumnListStatementEnabled(boolean baseNimbleColumnListStatementEnabled) {
        this.baseNimbleColumnListStatementEnabled = baseNimbleColumnListStatementEnabled;
    }

    public boolean isNimbleSelectByExampleStatementEnabled() {
        return nimbleSelectByExampleStatementEnabled;
    }

    public void setNimbleSelectByExampleStatementEnabled(boolean nimbleSelectByExampleStatementEnabled) {
        this.nimbleSelectByExampleStatementEnabled = nimbleSelectByExampleStatementEnabled;
    }
