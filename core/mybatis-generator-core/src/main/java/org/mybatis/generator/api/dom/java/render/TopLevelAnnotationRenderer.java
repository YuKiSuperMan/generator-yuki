...
import org.mybatis.generator.api.dom.java.TopLevelAnnotation;
...
public class TopLevelAnnotationRenderer {

    public String render(TopLevelAnnotation topLevelClass) {
        ...
        lines.addAll(renderInnerAnnotationNoIndent(topLevelClass, topLevelClass));
