 ...
 */
public class BaseNimberColumListElementGenerator extends AbstractXmlElementGenerator {

    public BaseNimberColumListElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", //$NON-NLS-1$
                introspectedTable.getBaseNimberListId()));

        context.getCommentGenerator().addComment(answer);
        XmlElement foreachElement = new XmlElement("foreach");
        foreachElement.addAttribute(new Attribute("collection", "columnNameList"));
