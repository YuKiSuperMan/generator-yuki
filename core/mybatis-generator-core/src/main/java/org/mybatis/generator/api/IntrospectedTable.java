...
public abstract class IntrospectedTable {
     ...
     * @author longxiangyu
     */
    public void setBaseNimberListId(String s){
        internalAttributes.put(InternalAttribute.ATTR_BASE_NIMBLE_COLUMN_ID,s);
    }

    public String getNimbleSelectByExampleId(){
        return internalAttributes.get(InternalAttribute.ATTR_NIMBLE_SELECT_BY_EXAMPLE_ID);
    }
    ...
    public String getBaseNimberListId() {
        return internalAttributes.get(InternalAttribute.ATTR_BASE_NIMBLE_COLUMN_ID);
    }
    ...
    protected void calculateBaseAttributes() {
    ...
    protected void calculateJavaBizAttributes() {
        if (context.getJavaBizGeneratorConfiguration() == null) {
            return;
        }

        StringBuilder sb = new StringBuilder();
        sb.append(calculateJavaBizPackage());
        sb.append('.');
        if (stringHasValue(fullyQualifiedTable.getDomainObjectSubPackage())) {
            sb.append(fullyQualifiedTable.getDomainObjectSubPackage());
            sb.append('.');
    ...
    public String getMyBatisBizType() {
        return internalAttributes.get(InternalAttribute.ATTR_BIZ_TYPE);
    }
    ...
    public void setBaseExampleType(String exampleType) {
        internalAttributes.put(InternalAttribute.ATTR_BASE_EXAMPLE_TYPE, exampleType);
    }
