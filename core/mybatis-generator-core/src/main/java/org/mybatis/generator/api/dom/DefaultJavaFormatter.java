...
import org.mybatis.generator.api.dom.java.render.TopLevelAnnotationRenderer;
...
public class DefaultJavaFormatter implements JavaFormatter, CompilationUnitVisitor<String> {
    ...
    @Override
    public String visit(TopLevelAnnotation topLevelInterface) {
        return new TopLevelAnnotationRenderer().render(topLevelInterface);
    }
}
