...
public class FullyQualifiedJavaType implements
    ...
    public static final FullyQualifiedJavaType getNewClassInstance() {
        return new FullyQualifiedJavaType("java.util.Map");
    }

    public static final FullyQualifiedJavaType getNewFieldInstance() {
        return new FullyQualifiedJavaType("java.lang.reflect.Field");
    }
