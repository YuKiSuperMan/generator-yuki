 ...
 */
public class LxyJavaClientGenerator  extends AbstractJavaClientGenerator {

    public LxyJavaClientGenerator(String project) {
        this(project, true);
    }

    public LxyJavaClientGenerator(String project, boolean requiresMatchedXMLGenerator) {
    ...
    protected void addNimbleSelectByExampleMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateNimbleSelectByExample()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new NimbleSelectByExampleMethodGenerator();
