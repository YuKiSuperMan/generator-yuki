...
public abstract class AbstractJavaType extends JavaElement {
    ...
    private List<InnerAnnotation> innerAnnotations = new ArrayList<>();
    ...
    public List<InnerAnnotation> getInnerAnnotations() { return innerAnnotations; }

    public void addInnerAnnotation(InnerAnnotation innerAnnotation) { this.innerAnnotations.add(innerAnnotation); }
