...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.LxyXMLMapperGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.YukiXMLMapperGenerator;
 ...
 */
public class YukiJavaNimbleClientGenerator extends AbstractJavaClientGenerator {

    public YukiJavaNimbleClientGenerator(String project) {
        this(project, true);
    }

    public YukiJavaNimbleClientGenerator(String project, boolean requiresMatchedXMLGenerator) {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(
                introspectedTable.getMyBatis3JavaNimbleMapperType());
        Interface interfaze = new Interface(type + "<T>");
...
//        addJoinNimbleSelectByExampleMethod(interfaze);
    ...
    protected void addNimbleSelectByExampleMethod(Interface interfaze) {
    ...
    protected void addJoinNimbleSelectByExampleMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateNimbleSelectByExample()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new JoinNimbleSelectByExampleMethodGenerator(true);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
//JoinNimbleSelectByExampleMethodGenerator
    ...
    public AbstractXmlGenerator getMatchedXMLGenerator() {
        return new YukiXMLMapperGenerator();
    }
}
