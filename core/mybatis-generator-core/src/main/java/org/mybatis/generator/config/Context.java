...
//        if (javaBizGeneratorConfiguration != null) {
...
//        }
    ...
    public JavaBizGeneratorConfiguration getJavaBizGeneratorConfiguration() {
        return javaBizGeneratorConfiguration;
    }
    ...
    public void generateFiles(ProgressCallback callback,
        ...
        if (introspectedTables != null) {
            ...
            if(!introspectedTables.isEmpty()) {
                introspectedTables.get(0).setStart(true);
            }
